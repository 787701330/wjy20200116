...
<script type="text/javascript">
  ...
  function operationFormatter(value,row,index){
	  ...
	  if(index==0&&pId!=1){
		  ...
		  html='<a title="操作" href="javascript:;" onclick="space_move(this,'+row.id+','+row.isFolder+')" style="text-decoration:none"><i class="Hui-iconfont"><span class="glyphicon glyphicon-pencil"></span></i></a>';
	      ...
	      html+='<a title="操作" href="javascript:;" onclick="space_move(this,'+row.id+')" style="text-decoration:none"><i class="Hui-iconfont"><span class="glyphicon glyphicon-pencil"></span></i></a>';
	      html+='<a title="删除"" href="javascript:;" onclick="space_del(this,'+row.id+')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont"><span class="glyphicon glyphicon-trash"></span></i></a>';
	  }
	  return html;
  }
