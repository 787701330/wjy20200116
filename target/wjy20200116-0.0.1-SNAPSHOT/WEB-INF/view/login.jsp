...
<body>
				...
				<div class="row cl">
					<div class="formControls col-xs-8 col-xs-offset-3">
						<input class="input-text size-L" type="text" placeholder="验证码"
							...
							name="verifyCode" id="verifyCode" value="验证码:"
							style="width: 150px;"> <img id="VerifyCodeImg"
							name="VerifyCodeImg" src="getVerifyCode.do" onclick="changCode()">
						<a id="kanbuq" href="javascript:;" onclick="changCode()">看不清，换一张</a>
					</div>
				</div>
				<div class="row cl">
					<div class="formControls col-xs-8 col-xs-offset-3">
						<label for="online"> <input type="checkbox"
							name="rememberMe"> 使我保持登录状态
						</label>
					</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					<div class="formControls col-xs-8 col-xs-offset-3">
						<input name="" type="submit" class="btn btn-success radius size-L"
							value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;"> <a
							href="javascript:;" onclick="zhuce()"
							class="btn btn-default radius size-L">&nbsp;注&nbsp;&nbsp;&nbsp;&nbsp;册&nbsp;</a>
					</div>
				</div>
			</form>
		</div>
	...
	<script>
		function changCode() {
			var src = "getVerifyCode.do?" + new Date().getTime();
			$('#VerifyCodeImg').prop("src", src)
		}

		function zhuce() {
			layer_show('注册', 'user/addUser.do')
		}
	</script>